  ...
  <div class="header-wrapper row m-0">
    ...
    <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
      <div class="d-flex align-items-center gap-2">
        <h4 class="f-w-600 mb-0">{{ $tenant->name }}</h4>
        <span class="badge badge-light-info">Company Portal</span>
      </div>
      <div class="welcome-content d-xl-block d-none">
        <span class="text-truncate col-12">Manage your company's pages, collections and data.</span>
      </div>
    </div>
        ...
        <li class="profile-nav onhover-dropdown p-0">
          <div class="d-flex profile-media align-items-center">
            ...
            <div class="flex-grow-1 ms-2">
              ...
              <p class="mb-0 font-roboto">Tenant Admin <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
