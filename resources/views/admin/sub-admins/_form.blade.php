        ...
        <form method="POST" action="{{ $action }}">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              @if ($roles->isEmpty())
                <small class="text-danger">No platform roles yet — create one under Roles first.</small>
              @endif
            </div>
          ...
          <div class="mt-3">
            <button type="submit" class="btn btn-primary">{{ $user->exists ? 'Save Sub Admin' : 'Create Sub Admin' }}</button>
