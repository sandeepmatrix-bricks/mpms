        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-hover align-middle">
              <thead>
                <tr><th>Name</th><th>Email</th><th>Role</th><th>Status</th><th class="text-end">Memberships</th><th class="text-end">Actions</th></tr>
              </thead>
              <tbody>
                @forelse ($users as $user)
                  <tr>
                    ...
                    <td>
                      @if ($user->is_admin)
                        <span class="badge badge-light-primary">Platform Admin</span>
                      @else
                        <span class="badge badge-light-secondary">Member</span>
                      @endif
                    </td>
                    <td>
                      <span class="badge badge-light-{{ $user->status === 'active' ? 'success' : 'secondary' }}">{{ ucfirst($user->status) }}</span>
                    </td>
                    <td class="text-end">{{ $user->memberships_count }}</td>
                    <td class="text-end">
